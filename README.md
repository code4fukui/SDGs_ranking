...
## Features
- Visualizes SDGs awareness and initiative scores for each prefecture in Japan
- Uses data scraped from an online report
- Allows selection of different metrics to display on an interactive map
